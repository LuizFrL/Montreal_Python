...
def get_inf_zabbix(inicio: str, fim: str):

    url = f'http://172.31.68.39/zabbix/index.php?request=report2.php%3Fmode%3D0%26from%3D{inicio}%2B00%253A00%253A00%26to%3D{fim}%2B23%253A59%253A59%26filter_groupid%3D4%26filter_hostid%3D10084%26filter_set%3D1'
    ...
    df_full.drop('Problems', inplace=True, axis=1)
    ...
    util = df_full[df_full.Name.isin(nomes_servicos)]
    return util


if __name__ == '__main__':
    a = get_inf_zabbix('2020-01-01', '2020-01-31')
    b = a[a['Name'] == 'Atendimento 1.0 - indisponível']
    print(b['Ok'][0])
